...
To make reproduction easier, we **directly provide the [SLM safety reasoning alignment dataset](https://huggingface.co/datasets/Horan27/EASE-STAR41K-SafetyReasoning-10K)** used in *Safety Reasoning Capability Implantation*.  
...
We release the [SLM safety reasoning alignment dataset](https://huggingface.co/datasets/Horan27/EASE-STAR41K-SafetyReasoning-10K) on HuggingFace. Please download it and place it under your data directory.
