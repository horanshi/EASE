...
<a href="https://huggingface.co/CWRUSafetyLab/Qwen2.5-1.5B-Instruct-EASE">🤗 Model(Qwen2.5-1.5B-Instruct-EASE)</a> &nbsp; | &nbsp;
<a href="https://huggingface.co/datasets/CWRUSafetyLab/EASE-STAR41K-SafetyReasoning-10K">🗂️ Dataset</a>
</p>
...
To make reproduction easier, we **directly provide the [SLM safety reasoning alignment dataset](https://huggingface.co/datasets/CWRUSafetyLab/EASE-STAR41K-SafetyReasoning-10K)** used in *Safety Reasoning Capability Implantation*.  
...
We release the [SLM safety reasoning alignment dataset](https://huggingface.co/datasets/CWRUSafetyLab/EASE-STAR41K-SafetyReasoning-10K) on HuggingFace. Please download it and place it under your data directory.
