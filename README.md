...
## Method (Phase 1: Safety Reasoning Capability Implantation)

To make reproduction easier, we **directly provide the 10,000 generated samples** used in *Safety Reasoning Capability Implantation — Step 2*.  
These data are generated by **DeepSeek-Qwen-14B-Distill** on **10,000 prompts from STAR-41K**.

### Step 1&2: Prepare the provided dataset
