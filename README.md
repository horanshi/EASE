...
🤗 [**Hugging Face Models**](https://huggingface.co/HaonanShi/Qwen2.5-1.5B-Instruct-EASE): https://huggingface.co/HaonanShi/Qwen2.5-1.5B-Instruct-EASE
🗂️ [**Hugging Face Dataset**](https://huggingface.co/datasets/HaonanShi/EASE-STAR41K-SafetyReasoning-10K): https://huggingface.co/datasets/HaonanShi/EASE-STAR41K-SafetyReasoning-10K
...
To make reproduction easier, we **directly provide the [SLM safety reasoning alignment dataset](https://huggingface.co/datasets/HaonanShi/EASE-STAR41K-SafetyReasoning-10K)** used in *Safety Reasoning Capability Implantation*.  
...
We release the [SLM safety reasoning alignment dataset](https://huggingface.co/datasets/HaonanShi/EASE-STAR41K-SafetyReasoning-10K) on HuggingFace. Please download it and place it under your data directory.
